...
from optsprime.unsupervised.embedding_evaluation import EmbeddingEvaluation
from optsprime.unsupervised.encoder import MoleculeEncoder
from optsprime.unsupervised.learning import GInfoMinMax
from optsprime.unsupervised.utils import initialize_edge_weight
from optsprime.unsupervised.view_learner import ViewLearner
...
def run(args):
    ...
    dataset = PygGraphPropPredDataset(name=args.dataset, root='./data/', transform=my_transforms)
