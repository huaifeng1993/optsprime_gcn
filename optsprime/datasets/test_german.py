...
from datasets.transfer_german_dataset import GermanDataset
...
def run(args):
    ...
    dataset = GermanDataset(root='./datasets',edge_file='./datasets/german_edges.csv',feature_file='./datasets/german_features.csv')
    ...
    valid_loader = DataLoader(val_datasets, batch_size=128, shuffle=False)
