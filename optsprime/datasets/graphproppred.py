...
def PyGPPDataset(name, root = 'dataset', split="train",transform=None, pre_transform = None, meta_dict = None):
    dataset=PygGraphPropPredDataset(name, root = 'dataset',transform=None, pre_transform = None, meta_dict = None)
    idx=dataset.get_idx_split()
    dataset=dataset[idx[split]]
    return dataset
...
if __name__ == '__main__':
    ...
    pyg_dataset = PygGraphPropPredDataset(name = 'ogbg-molesol',root="data/original_datasets")
    print(pyg_dataset.num_classes)
    split_index = pyg_dataset.get_idx_split()
    print(pyg_dataset[0])
