...
class GermanDataset(InMemoryDataset):
	...
	@property
	def raw_file_names(self):
		return ['german_edges.csv','german_feature.csv']
	@property
	def raw_dir(self):
	...
	def process(self):
		...
		edge_df = pd.read_csv(self.edge_file)
...
if __name__ == "__main__":
	...
	dataset = GermanDataset(root='./original_datasets/Genman',edge_file='./original_datasets/Genman/raw/german_edges.csv',feature_file='./original_datasets/Genman/raw/german_features.csv')
	# train_loader = DataLoader(dataset, batch_size=128, shuffle=True)
	print(len(dataset))
	print(len(dataset[0]))
	# root_unsupervised = './datasets/bio/unsupervised'
