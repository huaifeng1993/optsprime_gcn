...
class Evaluater(object):
    def __init__(self,log_name,save_csv=True):
        ...
        if self.save_csv:
            ...
            self.f=open(os.path.join(self.log_path,"eval_log.txt"),"w")
    
    def clc_update(self,label,pred_prob,pred_res=None):
        self.count+=1
        ...
        if self.save_csv:
            ...
            return {"auc":auc,"ap":ap,"acc":acc,"prec":prec,"rec":rec,"f1":f1,"type1_e":type_1,"type2_e":type_2,"h_measure":h_measure,"g_mean":g_score}
    ...
    def mean(self):
        ...
        if self.save_csv:
            ...
            res={"auc_mean":self.auc_sum/self.count,
                ...
                "g_mean":self.g_sum/self.count}
            return res
        return {"auc_mean":self.auc_sum/self.count,"ap_mean": self.ap_sum/self.count}
